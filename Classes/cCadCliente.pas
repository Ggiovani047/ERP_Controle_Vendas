      ...
      on E: Exception do
        begin
          ...
          if Pos('fk_', LowerCase(E.Message)) > 0 then
            MessageDlg('Você não pode excluir esse cliente pois ela está atrelada a um produto ',mtInformation,[mbOk],0)
          else
...
begin
  try
    ...
    if iResponse.StatusCode = 200 then begin
      ...
      ShowMessage('DDD Inválido'+ IntToStr(iResponse.StatusCode));
      Result:= False;
    end;
